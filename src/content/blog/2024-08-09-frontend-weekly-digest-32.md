...
- **(✍️) [Challenges in Writing a Programming Book](https://dev.to/this-is-learning/challenges-in-writing-a-programming-book-4dh9?ref=heristop.github.io)**
...
- **(🔮) [The Future of Vue.js (with Evan You)](https://share.transistor.fm/s/afeb8c47?ref=heristop.github.io)**
...
- **(🔠) [Letter Spacing is Broken and There’s Nothing We Can Do About It… Maybe](https://css-tricks.com/letter-spacing-is-broken-and-theres-nothing-we-can-do-about-it-maybe/?ref=heristop.github.io)**
...
- **(💻) [Windows 11 Clone with ReactJS](https://dev.to/misery666/windows-11-clone-with-reactjs-497j?ref=heristop.github.io)**
...
- **(🌟) [What's New in Astro - July 2024](https://astro.build/blog/whats-new-july-2024/?ref=heristop.github.io)**
...
- **(🤔) [The Differences Between "export default xx" and "export {xx as default}"](https://webdeveloper.beehiiv.com/p/differences-export-default-xx-export-xx-default?ref=heristop.github.io)**
...
- **(🎯) [7 Best Product Tour JavaScript Libraries for Frontend Apps](https://blog.logrocket.com/best-product-tour-js-libraries-frontend-apps/?ref=heristop.github.io)**
...
- **(🚀) [Optimizing Angular Performance with HttpInterceptor Caching](https://blog.openreplay.com/optimizing-angular-performance-with-httpinterceptor-caching/?ref=heristop.github.io)**
...
- **(🛠️) [Using the Shadow DOM as a Better Iframe](https://mailcoach.app/resources/blog/using-the-shadow-dom-as-a-better-iframe?ref=heristop.github.io)**

  Discover how to use the shadow DOM to create encapsulated web components, providing a better alternative to iframes.

## 🪐 Explore More

- **(🏅) [CSS Olympic Rings](https://css-tricks.com/css-olympic-rings/?ref=heristop.github.io)**
...
- **(🔄) [Zoneless Change Detection in Angular 18](https://blog.logrocket.com/zoneless-change-detection-angular-18/?ref=heristop.github.io)**
...
- **(🚀) [Exploring Vue SSR with Fastify](https://blog.platformatic.dev/exploring-vue-ssr-with-fastify/?ref=heristop.github.io)**
...
- **(⚛️) [React: Implementation of Microfrontend with Vite Compiler](https://blog.stackademic.com/implementation-of-microfrontend-with-vite-compiler-b534e3169955?ref=heristop.github.io)**
...
<div class="img-container">
  <img src="/images/posts/2024-08-09-frontend-weekly-digest-32/swimmers.webp" alt="swimmers" class="img-responsive" />
</div>
