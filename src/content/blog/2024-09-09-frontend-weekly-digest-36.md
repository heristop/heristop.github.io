...
- **(💡) [Frontend Performance Love Story](https://itnext.io/frontend-performance-love-story-ce92302fea5f?ref=heristop.github.io)**
...
- **(⚡) [Look out, kids: PHP is the new JavaScript](https://www.mux.com/blog/php-is-the-new-javascript?ref=heristop.github.io)**
...
- **(🧠) [JavaScript Generators Explained, But On A Senior-Level](https://www.reactsquad.io/blog/understanding-generators-in-javascript?ref=heristop.github.io)**
...
- **(🔍) [What are Code Smells in Angular?](https://blog.bitsrc.io/code-smells-in-angular-ce73bf7db072?ref=heristop.github.io)**
...
- **(🔧) [Nuxt 3.13 is out](https://nuxt.com/blog/v3-13?ref=heristop.github.io)**
...
- **(💥) [Announcing Rspack 1.0](https://rspack.dev/blog/announcing-1-0?ref=heristop.github.io)**
...
- **(🔒) [Frontend Security Checklist](https://www.trevorlasn.com/blog/frontend-security-checklist?ref=heristop.github.io)**
...
- **(🎨) [Creating and styling components in Angular correctly](https://blog.stackademic.com/creating-and-styling-components-in-angular-correctly-52c93b062759?ref=heristop.github.io)**
...
- **(📅) [JS Dates Are About to Be Fixed](https://docs.timetime.in/blog/js-dates-finally-fixed?ref=heristop.github.io)**
...
- **(🖼) [CSS display contents](https://ishadeed.com/article/display-contents?ref=heristop.github.io)**
...
- **(📈) [The future is standalone!](https://blog.angular.dev/the-future-is-standalone-475d7edbc706?ref=heristop.github.io)**
...
- **(🔎) [THE SECRET INSIDE ONE MILLION CHECKBOXES](https://eieio.games/essays/the-secret-in-one-million-checkboxes?ref=heristop.github.io)**
...
- **(🔭) [Explore the New Zoneless Change Detection in Angular 18](https://www.telerik.com/blogs/explore-new-zoneless-change-detection-angular-18?ref=heristop.github.io)**
...
- **(🎥) [21 Talks from the Chain React 2024 Conference](https://www.youtube.com/playlist?list=PLE7tQUdRKcyb81ybEVsrk6PfxXu7pJs1i#chainreact2024?ref=heristop.github.io)**
...
- **(👀) [Node.js Doesn’t Suck Anymore](https://www.youtube.com/watch?v=si9pVRaGz30&t=19s?ref=heristop.github.io)**
