...
- **(📈) [Svelte Summit Fall 2023 Highlights](https://svelte.dev/blog/whats-new-in-svelte-december-2023?ref=heristop.github.io)**
...
- **(🚀) [Vitest v1.0.0 Release](https://github.com/vitest-dev/vitest/releases/tag/v1.0.0?ref=heristop.github.io)**

  The official release of Vitest version 1.0.0, a Vite-native test framework.

## 📝 Articles & Guides

- **(✏️) [Frontend Rewind 2023 – Day 01](https://tympanus.net/codrops/2023/12/01/frontend-rewind-2023-day-01?ref=heristop.github.io)**
...
- **(🎨) [Scribble Diffusion](https://scribblediffusion.com?ref=heristop.github.io)**
...
- **(🌐) [Iconbuddy: Extensive Open Source Icon Collection](https://iconbuddy.app?ref=heristop.github.io)**
...
- **(🌿) [Elysium: A Tranquil 3D Nature World](https://elysium.thebenezer.com?ref=heristop.github.io)**
