...
- **(🌟) [Signals And Array Mutability In Angular 18](https://www.bennadel.com/blog/4701-signals-and-array-mutability-in-angular-18.htm?ref=heristop.github.io)**
...
- **(🚀) [Bye Bye, Try-Catch Blocks: Meet JavaScript's Safe Assignment Operator Proposal](https://dev.to/dharamgfx/bye-bye-try-catch-blocks-meet-javascripts-safe-assignment-operator-proposal-1j7?ref=heristop.github.io)**
...
- **(🔧) [CSS finally adds vertical centering in 2024](https://build-your-own.org/blog/20240813_css_vertical_center?ref=heristop.github.io)**
...
- **(🧰) [Benefits Of Modular Design In Front-End Development](https://blog.openreplay.com/benefits-of-modular-design-for-front-end-development/?ref=heristop.github.io)**
...
- **(🖥) [Tracking supermarket prices with Playwright](https://sakisv.net/2024/08/tracking-supermarket-prices-playwright/?ref=heristop.github.io)**
...
- **(🎨) [Layering CSS gradients](https://cassidoo.co/post/layer-css-gradients/?ref=heristop.github.io)**
...
- **(🔍) [Debugging TypeScript With Visual Studio Code](https://blog.openreplay.com/debugging-typescript-with-visual-studio-code?ref=heristop.github.io)**
...
- **(⏳) [Optimizing CSS time-based animations with new CSS functions](https://blog.logrocket.com/optimizing-css-time-based-animations-new-css-functions?ref=heristop.github.io)**
