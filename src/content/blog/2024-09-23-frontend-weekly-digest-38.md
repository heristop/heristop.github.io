...
- **(🎨) [15 Useful CSS Properties You Should Know About 🎨](https://kaderbiral26.medium.com/15-useful-css-properties-you-should-know-about-d924343d6f9c?ref=heristop.github.io)**
...
- **(💡) [Advanced Animations With CSS Linear()](https://blog.openreplay.com/advanced-animations-with-css-linear/?ref=heristop.github.io)**
...
- **(🔄) [Mastering promise cancellation in JavaScript](https://blog.logrocket.com/mastering-promise-cancellation-javascript/?ref=heristop.github.io)**
...
- **(🛠) [Implementing a Global Error Handler in Angular: A Step-by-Step Guide](https://www.telerik.com/blogs/implementing-global-error-handler-angular-step-guide?ref=heristop.github.io)**
...
- **(🌀) [How to Share Angular Code Between Projects?](https://www.syncfusion.com/blogs/post/share-angular-code-between-projects?ref=heristop.github.io)**
...
- **(🔨) [How to build scalable micro-frontends with Vike and Vite](https://blog.logrocket.com/build-scalable-micro-frontends-vike-vite/?ref=heristop.github.io)**
...
- **(🔧) [State Management in Angular Applications Using NgRx Signals Store](https://www.telerik.com/blogs/state-management-angular-applications-using-ngrx-signals-store?ref=heristop.github.io)**
...
- **(✂️) [Another Stab at Truncated Text](https://css-tricks.com/another-stab-at-truncated-text/?ref=heristop.github.io)**
...
- **(🚦) [Intuitive Explanation of Async / Await in JavaScript](https://towardsdatascience.com/intuitive-explanation-of-async-await-in-javascript-730174c000bd?ref=heristop.github.io)**
...
- **(❓) [Bad Questions for Senior Frontend Dev Interview](https://medium.com/@maks-dolgikh/bad-questions-for-senior-frontend-dev-interview-2c94dd937d75?ref=heristop.github.io)**
