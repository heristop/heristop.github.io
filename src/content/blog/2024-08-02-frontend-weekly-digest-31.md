...
- **(🚀) [What’s New for JavaScript Developers in ECMAScript 2024](https://thenewstack.io/whats-new-for-javascript-developers-in-ecmascript-2024/?ref=heristop.github.io)**
...
- **(💡) [We Can Finally Animate height: auto; in CSS!](https://blog.webdevsimplified.com/2024-07/css-calc-size/?ref=heristop.github.io)**
...
- **(🔧) [What's new in DevTools, Chrome 127](https://developer.chrome.com/blog/new-in-devtools-127/?ref=heristop.github.io)**
...
- **(🛠️) [Feature detect CSS @starting-style support](https://www.bram.us/2024/07/11/feature-detect-css-starting-style-support/?ref=heristop.github.io)**
...
- **(🔗) [Event Delegation vs Event Propagation in JavaScript](https://dev.to/mdhassanpatwary/event-delegation-vs-event-propagation-in-javascript-m9n?ref=heristop.github.io)**
...
- **(📦) [What's the Difference Between the useMemo and useCallback Hooks?](https://www.freecodecamp.org/news/difference-between-usememo-and-usecallback-hooks/?ref=heristop.github.io)**
...
- **(🧰) [8 Must-have Websites to Master UI/UX Skills](https://uxplanet.org/8-must-have-websites-to-master-ui-ux-skills-5861984d6928?ref=heristop.github.io)**
...
- **(🧼) [Clean Code: 7 tips to write clean functions](https://craftbettersoftware.com/p/clean-code-7-tips-to-write-clean?ref=heristop.github.io)**

  Provides seven practical tips for writing clean, maintainable functions in code, emphasizing clarity and simplicity.

## 🪐 Explore More

- **(⚛️) [React Components Demystified: Your Ultimate Guide from Newbie to Ninja](https://dev.to/vyan/react-components-demystified-your-ultimate-guide-from-newbie-to-ninja-3l1n?ref=heristop.github.io)**
...
- **(📝) [Histoire: A new way to write stories](https://histoire.dev/?ref=heristop.github.io)**
...
- **(📊) [Structured Data: What It Is and Why You Need It](https://www.builder.io/m/explainers/structured-data?ref=heristop.github.io)**
...
<div class="img-container">
  <img src="/images/posts/2024-08-02-frontend-weekly-digest-31/surfer.webp" alt="surfer" class="img-fixed-height" />
</div>
