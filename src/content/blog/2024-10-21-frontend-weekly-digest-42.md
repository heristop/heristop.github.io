...
- **(🚀) [Improving Core Web Vitals with Partial Hydration in Angular 18](https://dev.to/this-is-angular/angular-18-improving-application-performance-with-partial-hydration-and-ssr-2nie?ref=heristop.github.io)**
...
- **(⚡) [Fixing JavaScript Performance Issues](https://developer.mozilla.org/en-US/blog/fix-javascript-performance/?ref=heristop.github.io)**
...
- **(🧪) [Why We Switched from Cypress to Playwright](https://www.bigbinary.com/blog/why-we-switched-from-cypress-to-playwright?ref=heristop.github.io)**
...
- **(🛠) [What's New in Chrome DevTools 130](https://developer.chrome.com/blog/new-in-devtools-130?ref=heristop.github.io)**
...
- **(🔧) [Deno 2.0 Released](https://deno.com/blog/v2.0?ref=heristop.github.io)**
...
- **(📢) [What's New in Svelte: October 2024](https://svelte.dev/blog/whats-new-in-svelte-october-2024?ref=heristop.github.io)**
...
- **(🆕) [Announcing VoidZero: New Partnership](https://voidzero.dev/posts/announcing-voidzero-inc?ref=heristop.github.io)**
...
- **(🔄) [Vue Basics: Pinia State Management](https://www.telerik.com/blogs/vue-basics-pinia-state-management?ref=heristop.github.io)**
...
- **(🎨) [Feature Detect Style Queries in CSS](https://www.bram.us/2024/10/06/feature-detect-style-queries-support-in-css/?ref=heristop.github.io)**
...
- **(🔧) [ESLint Now Supports JSON and Markdown](https://eslint.org/blog/2024/10/eslint-json-markdown-support/?ref=heristop.github.io)**
...
- **(🖼) [SVG Coding Examples: Hand-Crafting Vectors](https://www.smashingmagazine.com/2024/09/svg-coding-examples-recipes-writing-vectors-by-hand/?ref=heristop.github.io)**
...
- **(📽) [Player: Customizable Video Players](https://player.style/?ref=heristop.github.io)**
...
- **(🧩) [How I Structure My Angular Components with Signals](https://dev.to/this-is-angular/how-i-structure-my-angular-components-with-signals-52lj?ref=heristop.github.io)**

  A guide on using Angular's signals API to create reactive components, making state management easier and more predictable.

## 🪐 Explore More

- **(📊) [Understanding Signals in Angular](https://blog.openreplay.com/understanding-signals-in-angular?ref=heristop.github.io)**
...
- **(🔢) [Two-Dimensional Arrays in JavaScript](https://www.kirupa.com/javascript/2d_arrays.htm?ref=heristop.github.io)**
...
- **(🔄) [Using Tailwind CSS to Prevent React Re-Renders](https://www.nico.fyi/blog/tailwind-css-group-modifier-to-prevent-react-rerender?ref=heristop.github.io)**

  Learn how to use Tailwind’s group modifier in React applications to reduce unnecessary re-renders, improving performance.

- **(🌐) [Web Components vs Framework Components](https://lea.verou.me/blog/2024/wcs-vs-frameworks/?ref=heristop.github.io)**
...
<div class="img-container">
  <img src="/images/posts/2024-10-21-frontend-weekly-digest-42/rocket.webp" alt="rocket" class="img-responsive" />
</div>
