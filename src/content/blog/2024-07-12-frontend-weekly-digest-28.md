...
- **(🔒) [Polyfill supply chain attack hits 100K+ sites](https://sansec.io/research/polyfill-supply-chain-attack?ref=heristop.github.io)**
...
- **(🚨) [Trojanized jQuery Packages Found on npm, GitHub, and jsDelivr Code Repositories](https://thehackernews.com/2024/07/trojanized-jquery-packages-found-on-npm.html?ref=heristop.github.io)**
...
- **(🚀) [Vitest 2.0 is here!](https://github.com/vitest-dev/vitest/releases/tag/v2.0.0?ref=heristop.github.io)**
...
- **(🎯) [100 FREE Frontend Challenges](https://dev.to/bigsondev/100-free-frontend-challenges-3f0?ref=heristop.github.io)**

  Enhance your frontend skills with these 100 free challenges, ranging from beginner to advanced levels.

- **(🎨) [Grainy Texture Using CSS Gradients](https://css-tip.com/grainy-texture/?ref=heristop.github.io)**

  Learn how to create a grainy texture effect using pure CSS gradients, adding a unique visual style to your projects.

- **(🔄) [Axios vs Fetch](https://dev.to/wafa_bergaoui/axios-vs-fetch-543c?ref=heristop.github.io)**

  A detailed comparison between Axios and Fetch, helping you choose the right HTTP client for your needs.

## 🪐 Explore More

- **(🤔) [What is this weird CSS Syntax?](https://dev.to/seths10/what-is-this-weird-css-syntax-44ki?ref=heristop.github.io)**

  Dive into the peculiarities of some lesser-known CSS syntax and how it can be utilized effectively in your projects.

- **(🔄) [Angular Basics: Controlling the Flow of Your Angular Templates (@if, @for, @switch)](https://www.telerik.com/blogs/angular-basics-controlling-flow-angular-templates-if-for-switch?ref=heristop.github.io)**

  Master the basics of controlling flow in Angular templates with @if, @for, and @switch directives.

- **(📏) [Transitioning to Auto Height](https://css-tricks.com/transitioning-to-auto-height/?ref=heristop.github.io)**
...
- **(📐) [The Hidden Challenges of Design Systems (And How to Solve Them)](https://www.builder.io/blog/challenges-of-design-systems?ref=heristop.github.io)**

  Identify and overcome the common challenges faced when implementing design systems in your projects.

- **(☁️) [Serverless vs. Traditional Hosting](https://dev.to/sh20raj/serverless-vs-traditional-hosting-2ckc?ref=heristop.github.io)**
