...
- **(⚡️) [onClick={someFunction} VS onClick={()=>someFunction}](https://dev.to/itric/onclicksomefunction-vs-onclicksomefunction-5d1i?ref=heristop.github.io)**
...
- **(📚) [7 Open Source Projects You Should Know - JavaScript Edition](https://dev.to/this-is-learning/7-open-source-projects-you-should-know-javascript-edition-150?ref=heristop.github.io)**

  An insightful list of seven must-know open source JavaScript projects. Your toolkit just got an upgrade!

- **(🎨) [Intro to colour contrast](https://goodpractices.design/articles/colour-contrast?ref=heristop.github.io)**
...
- **(🆕) [New JavaScript Set methods](https://developer.mozilla.org/en-US/blog/javascript-set-methods/?ref=heristop.github.io)**

  A look at the latest methods added to JavaScript Sets, expanding their functionality. More tools for your coding toolkit!

- **(🚀) [Turborepo 2.0](https://turbo.build/blog/turbo-2-0?ref=heristop.github.io)**
...
- **(✨) [Astro 4.11](https://astro.build/blog/astro-4110?ref=heristop.github.io)**

  Check out the updates and new features in Astro version 4.11. Starry updates ahead!

- **(⚙️) [TypeScript 5.5: Faster, Smarter and More Powerful](https://thenewstack.io/typescript-5-5-faster-smarter-and-more-powerful/?ref=heristop.github.io)**
...
- **(🛠) [How to Mock Child Components When Writing Angular Tests](https://spin.atomicobject.com/mock-child-component-angular/?ref=heristop.github.io)**
...
- **(📖) [Generate documentation for your Angular application with Compodoc](https://rubenperegrina.com/generate-documentation-for-your-angular-application-with-compodoc?ref=heristop.github.io)**
...
- **(🔍) [How to Visual Test Websites with Chromatic and Playwright](https://tympanus.net/codrops/2024/06/17/how-to-visual-test-websites-with-chromatic-and-playwright/?ref=heristop.github.io)**

  Step-by-step instructions on setting up visual testing for websites using Chromatic and Playwright. See it to believe it!

- **(🔎) [Deep Dive into Nx Affected](https://itnext.io/deep-dive-into-nx-affected-b3c29c715d41?ref=heristop.github.io)**

  An in-depth exploration of the Nx Affected command and its use in large-scale projects. Dive deep into the heart of Nx!

- **(🔧) [Exploring the CSS display property: A deep dive](https://blog.logrocket.com/exploring-css-display-property?ref=heristop.github.io)**

  A thorough examination of the CSS display property and its various uses in web design. Display your skills with style!

## 🪐 Explore More

- **(🎥) [JS World Conference 2024 Replays](https://jsworldconference.com/sessions?ref=heristop.github.io)**

  Watch the replays of sessions from the JS World Conference 2024. Rewind, play, and learn!

- **(📑) [Qwik adoption guide: Overview, examples, and alternatives](https://blog.logrocket.com/qwik-adoption-guide/?ref=heristop.github.io)**

  A guide to adopting Qwik in your projects, with examples and comparisons to other frameworks. Quick tips for Qwik success!

- **(🔄) [Nx and Turborepo](https://nx.dev/concepts/turbo-and-nx?ref=heristop.github.io)**
...
- **(📈) [7 Technical Updates to Boost Website Performance](https://thenewstack.io/7-technical-updates-to-boost-website-performance/?ref=heristop.github.io)**
