...
- **(🛌) [Lazy Loading](https://dev.to/jorjishasan/lazy-loading-lod?ref=heristop.github.io)**
...
- **(🌐) [New ESM JavaScript Registry Runtime Agnostic](https://jsr.io/?ref=heristop.github.io)**
...
- **(💨) [Vue Vapor Mode (No Virtual DOM)](https://icarusgk.hashnode.dev/vue-3-vapor-mode?ref=heristop.github.io)**

  An experimental exploration by Vue.js into a potential future without a virtual DOM, focusing on direct DOM manipulation for performance gains: [Repo](https://github.com/vuejs/core-vapor?ref=heristop.github.io)

- **(⚡) [Speed Comparison Dart/JS/Rust](https://medium.com/@tommyyy/the-dart-speed-035272e9d46d?ref=heristop.github.io)**
...
- **(📈) [TypeScript v5.4](https://devblogs.microsoft.com/typescript/announcing-typescript-5-4/?ref=heristop.github.io)**
...
- **(📝) [BlockNote.js under React (Notion Textarea)](https://www.blocknotejs.org/?ref=heristop.github.io)**

  Showcases BlockNote.js, a React library offering Notion-like text area components for rich text editing experiences.

- **(📘) [4th Edition of "Eloquent JavaScript"](https://eloquentjavascript.net/?ref=heristop.github.io)**
...
- **(🚀) [Adonis v6 Migration Vite](https://techreads.pipoprods.org/add-vue-js-vite-to-an-adonisjs-application/?ref=heristop.github.io)**

  Guides on integrating Vite with AdonisJS for a modernized development setup, focusing on Adonis version 6 projects.

## 🛠 Tools & Resources

- **(❄️) [Announcing WinterJS 1.0](https://wasmer.io/posts/winterjs-v1?ref=heristop.github.io)**
...
- **(📚) [How to Build a Basic CMS with Google Sheets and React](https://www.freecodecamp.org/news/how-to-build-a-basic-cms-with-google-sheets-and-reactjs/?ref=heristop.github.io)**
...
- **(📖) [Async vs Defer in JavaScript: Which is Better?](https://dev.to/fidalmathew/async-vs-defer-in-javascript-which-is-better-26gm?ref=heristop.github.io)**
